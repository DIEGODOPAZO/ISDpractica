...
public class ClientPartidoServiceFactory {
    ...
    private final static String CLASS_NAME_PARAMETER = "ClientPartidoServiceFactory.className";
    ...
    private synchronized static Class<ClientPartidoService> getServiceClass() {
        ...
        if (serviceClass == null) {
            try {
                ...
                //serviceClass = (Class<ClientPartidoService>) Class.forName("es.udc.ws.app.client.service.rest.RestClientPartidoService");
            } catch (Exception e) {
